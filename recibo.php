...
if (!$r || ($r['id_usuario'] != $_SESSION['usuario_id'] && !in_array($_SESSION['rol'], ['admin', 'superadmin']))) {
    include '/var/www/html/includes/header.php';
    echo '<div class="container py-5 text-center"><h3>Recibo no encontrado.</h3><a href="/mis-pedidos.php">Volver</a></div>';
